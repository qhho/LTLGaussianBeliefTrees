...
class Scene
{
    public:
        ...
        unsigned int n_regions_ = 0;

        std::vector<Eigen::Matrix<float, 6, 3> > A_list_regions_;
        std::vector<Eigen::Matrix<float, 6, 1> > B_list_regions_;
    ...
    private:
        ...
        void define_cube_as_constraints_regions(const double &fx, const double &tx, const double &fy, const double &ty, const double &fz, const double &tz);
};